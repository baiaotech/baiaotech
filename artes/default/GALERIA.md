...
![Visão geral do primeiro grupo](previews/painel-1.png)

![Visão geral do segundo grupo](previews/painel-2.png)

## Referência já aprovada

Preservada sem alterações para comparação com o modelo editável de PyLadies Maceió.

![Referência aprovada de PyLadies Maceió](referencias/pyladies-maceio-aprovado.png)

## 01. PyLadies Maceió

Mulheres, pertencimento e conexões; deriva da referência aprovada de PyLadies Maceió.

![Card completo de PyLadies Maceió — nome, campos de evento e rodapé do Baião Tech](comunidades/pyladies-maceio/previa.png)
...
![Card completo de PyLadies Salvador — nome, campos de evento e rodapé do Baião Tech](comunidades/pyladies-salvador/previa.png)
...
![Card completo de GDG Fortaleza — nome, campos de evento e rodapé do Baião Tech](comunidades/gdg-fortaleza/previa.png)
...
![Card completo de GDG Recife — nome, campos de evento e rodapé do Baião Tech](comunidades/gdg-recife/previa.png)
...
![Card completo de AWS User Group João Pessoa — nome, campos de evento e rodapé do Baião Tech](comunidades/aws-user-group-joao-pessoa/previa.png)
...
![Card completo de GDG Natal — nome, campos de evento e rodapé do Baião Tech](comunidades/gdg-natal/previa.png)
...
![Card completo de GDG Aracaju — nome, campos de evento e rodapé do Baião Tech](comunidades/gdg-aracaju/previa.png)
...
![Card completo de Cloud Native São Luís — nome, campos de evento e rodapé do Baião Tech](comunidades/cloud-native-sao-luis/previa.png)
...
![Card completo de Teresina Hacker Clube — nome, campos de evento e rodapé do Baião Tech](comunidades/teresina-hacker-clube/previa.png)
...
![Card completo de DevOps CE — nome, campos de evento e rodapé do Baião Tech](comunidades/devops-ce/previa.png)
...
![Card completo de Genérico com logo — nome, campos de evento e rodapé do Baião Tech](genericos/com-logo/previa.png)
