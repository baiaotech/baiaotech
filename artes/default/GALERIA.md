...
![Card completo — PyLadies Maceió](comunidades/pyladies-maceio/previa.png)

[SVG editável](comunidades/pyladies-maceio/modelo.svg) · [Estilo e origem](comunidades/pyladies-maceio/estilo.json)

## PyLadies Salvador

Duas mulheres em mentoria e programação em dupla, com paisagem inspirada na baía de Salvador.

![Card completo — PyLadies Salvador](comunidades/pyladies-salvador/previa.png)

[SVG editável](comunidades/pyladies-salvador/modelo.svg) · [Estilo e origem](comunidades/pyladies-salvador/estilo.json)

## GDG Fortaleza

Codelab de aplicativos, smartphone e interfaces, com inspiração na orla de Fortaleza.

![Card completo — GDG Fortaleza](comunidades/gdg-fortaleza/previa.png)

[SVG editável](comunidades/gdg-fortaleza/modelo.svg) · [Estilo e origem](comunidades/gdg-fortaleza/estilo.json)

## GDG Recife

Troca de conhecimento em grupo, quadro de conexões e paisagem inspirada nos rios e pontes do Recife.

![Card completo — GDG Recife](comunidades/gdg-recife/previa.png)

[SVG editável](comunidades/gdg-recife/modelo.svg) · [Estilo e origem](comunidades/gdg-recife/estilo.json)

## AWS User Group João Pessoa

Discussão de arquitetura em nuvem, módulos conectados e paisagem costeira inspirada em João Pessoa.

![Card completo — AWS User Group João Pessoa](comunidades/aws-user-group-joao-pessoa/previa.png)

[SVG editável](comunidades/aws-user-group-joao-pessoa/modelo.svg) · [Estilo e origem](comunidades/aws-user-group-joao-pessoa/estilo.json)

## GDG Natal

Experimentação de interfaces em tablets e notebooks, com degraus e dunas inspiradas em Natal.

![Card completo — GDG Natal](comunidades/gdg-natal/previa.png)

[SVG editável](comunidades/gdg-natal/modelo.svg) · [Estilo e origem](comunidades/gdg-natal/estilo.json)

## GDG Aracaju

Encontro e conversa entre desenvolvedores, balões de ideias e paisagem fluvial inspirada em Aracaju.

![Card completo — GDG Aracaju](comunidades/gdg-aracaju/previa.png)

[SVG editável](comunidades/gdg-aracaju/modelo.svg) · [Estilo e origem](comunidades/gdg-aracaju/estilo.json)

## Cloud Native São Luís

Profissionais colaborando com infraestrutura, nuvem e servidores conectados.

![Card completo — Cloud Native São Luís](comunidades/cloud-native-sao-luis/previa.png)

[SVG editável](comunidades/cloud-native-sao-luis/modelo.svg) · [Estilo e origem](comunidades/cloud-native-sao-luis/estilo.json)
...
![Card completo — Teresina Hacker Clube](comunidades/teresina-hacker-clube/previa.png)

[SVG editável](comunidades/teresina-hacker-clube/modelo.svg) · [Estilo e origem](comunidades/teresina-hacker-clube/estilo.json)

## DevOps CE

Colaboração em confiabilidade, telas de operação e ciclo contínuo de automação.

![Card completo — DevOps CE](comunidades/devops-ce/previa.png)

[SVG editável](comunidades/devops-ce/modelo.svg) · [Estilo e origem](comunidades/devops-ce/estilo.json)

## Ceará Java User Group

Troca intergeracional de conhecimento e módulos do ecossistema JVM no Ceará.

![Card completo — Ceará Java User Group](comunidades/ceara-java-user-group/previa.png)

[SVG editável](comunidades/ceara-java-user-group/modelo.svg) · [Estilo e origem](comunidades/ceara-java-user-group/estilo.json)

## Cloud Native RN

Oficina colaborativa de nuvem e microsserviços junto às dunas de Natal.

![Card completo — Cloud Native RN](comunidades/cloud-native-rn/previa.png)

[SVG editável](comunidades/cloud-native-rn/modelo.svg) · [Estilo e origem](comunidades/cloud-native-rn/estilo.json)

## CODAR Salvador

Desenvolvimento open-source colaborativo e conexões entre módulos na baía de Salvador.

![Card completo — CODAR Salvador](comunidades/codar-salvador/previa.png)

[SVG editável](comunidades/codar-salvador/modelo.svg) · [Estilo e origem](comunidades/codar-salvador/estilo.json)

## Conecta Nordeste

Conexões entre empreendedores e ecossistemas de inovação do Nordeste.

![Card completo — Conecta Nordeste](comunidades/conecta-nordeste/previa.png)

[SVG editável](comunidades/conecta-nordeste/modelo.svg) · [Estilo e origem](comunidades/conecta-nordeste/estilo.json)

## DevOps JP

Responsabilidade compartilhada pela entrega e confiabilidade de software em João Pessoa.

![Card completo — DevOps JP](comunidades/devops-jp/previa.png)

[SVG editável](comunidades/devops-jp/modelo.svg) · [Estilo e origem](comunidades/devops-jp/estilo.json)

## Django Girls Salvador

Primeiros passos na programação web com mentoria inclusiva entre mulheres em Salvador.

![Card completo — Django Girls Salvador](comunidades/django-girls-salvador/previa.png)

[SVG editável](comunidades/django-girls-salvador/modelo.svg) · [Estilo e origem](comunidades/django-girls-salvador/estilo.json)

## DotNet Recife

Conhecimento compartilhado sobre camadas de aplicações e serviços .NET no Recife.

![Card completo — DotNet Recife](comunidades/dotnet-recife/previa.png)

[SVG editável](comunidades/dotnet-recife/modelo.svg) · [Estilo e origem](comunidades/dotnet-recife/estilo.json)

## Elug CE

Programação funcional, processos e troca de mensagens como construção colaborativa no Ceará.

![Card completo — Elug CE](comunidades/elug-ce/previa.png)

[SVG editável](comunidades/elug-ce/modelo.svg) · [Estilo e origem](comunidades/elug-ce/estilo.json)

## FEMUG-PE

Criação colaborativa de interfaces responsivas e experimentação front-end no Recife.

![Card completo — FEMUG-PE](comunidades/femug-pe/previa.png)

[SVG editável](comunidades/femug-pe/modelo.svg) · [Estilo e origem](comunidades/femug-pe/estilo.json)

## ForHacker Space

Laboratório comunitário de hardware livre e eletrônica, com aprendizado prático entre makers em Fortaleza.
...
![Card completo — com-logo](genericos/com-logo/previa.png)

[SVG editável](genericos/com-logo/modelo.svg) · [Estilo e origem](genericos/com-logo/estilo.json)

## Genérico sem-logo

Comunidade aberta de tecnologia e conexão entre pessoas, sem atribuição a uma organização cadastrada.

![Card completo — sem-logo](genericos/sem-logo/previa.png)

[SVG editável](genericos/sem-logo/modelo.svg) · [Estilo e origem](genericos/sem-logo/estilo.json)
